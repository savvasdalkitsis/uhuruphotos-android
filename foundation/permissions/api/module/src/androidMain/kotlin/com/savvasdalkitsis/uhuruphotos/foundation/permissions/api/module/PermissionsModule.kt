 ...
 */
package com.savvasdalkitsis.uhuruphotos.foundation.permissions.api.module
...
object PermissionsModule {
    ...
    val permissionFlow: PermissionFlow by singleInstance {
        PermissionFlow.init(AndroidModule.applicationContext)
