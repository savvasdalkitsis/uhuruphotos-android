...
actual object PlatformNavigationModule {

    actual val externalNavigator: ExternalNavigator
        get() = IntentLauncher(AndroidModule.applicationContext, ToasterModule.toasterUseCase)
}