...
class Navigator(
    ...
    override fun navigateToWeb(webUrl: String) {
        externalNavigator.navigateToWeb(webUrl)
    }

    override fun navigateTo(externalTarget: ExternalNavigationTarget) {
        onMain {
            externalNavigator.navigateTo(externalTarget)
        }
    }

    override fun navigateTo(externalTarget: ExternalNavigationTarget, fallbackExternalTarget: ExternalNavigationTarget) {
        onMain {
            externalNavigator.navigateTo(externalTarget, fallbackExternalTarget)
        }
    }
