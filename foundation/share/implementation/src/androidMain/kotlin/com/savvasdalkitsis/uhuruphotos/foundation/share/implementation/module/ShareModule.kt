...
internal object ShareModule {

        fun shareUseCase(shareUseCase: ShareUseCase):
            com.savvasdalkitsis.uhuruphotos.foundation.share.api.usecase.ShareUseCase = shareUseCase
