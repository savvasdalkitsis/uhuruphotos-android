 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.{{cookiecutter.project_slug}}.view.implementation.ui
...
@Composable
internal fun {{cookiecutter.project_slug.capitalize()}}(
    state: {{cookiecutter.project_slug.capitalize()}}State,
    action: ({{cookiecutter.project_slug.capitalize()}}Action) -> Unit,
) {
