...
import com.savvasdalkitsis.uhuruphotos.feature.widget.view.implementation.seam.effects.NavigateToFavourite
...
data class OpenFavourite(val id: MediaId<*>) : FavouritesWidgetAction() {
    context(WidgetActionsContext) override fun handle(
        state: FavouritesWidgetState,
        effect: EffectHandler<WidgetEffect>
    ): Flow<Mutation<FavouritesWidgetState>> = flow {
        effect.handleEffect(NavigateToFavourite(id))
    }
