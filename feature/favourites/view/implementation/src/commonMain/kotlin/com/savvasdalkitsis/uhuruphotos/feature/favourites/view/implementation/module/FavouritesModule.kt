 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.favourites.view.implementation.module

import com.savvasdalkitsis.uhuruphotos.feature.favourites.domain.api.module.FavouritesModule
...
internal object FavouritesModule {
    ...
    val favouritesActionsContext get() = FavouritesActionsContext(
        CommonMediaModule.mediaUseCase,
        FavouritesModule.favouritesUseCase,
