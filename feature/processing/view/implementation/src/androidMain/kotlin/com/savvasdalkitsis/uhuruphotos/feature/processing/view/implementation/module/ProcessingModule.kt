 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.processing.view.implementation.module

import com.savvasdalkitsis.uhuruphotos.feature.media.remote.domain.api.module.RemoteMediaModule
import com.savvasdalkitsis.uhuruphotos.feature.processing.domain.api.module.ProcessingModule
...
internal object ProcessingModule {
    ...
    val processingActionsContext get() = ProcessingActionsContext(
        ProcessingModule.processingUseCase,
