...
data object DismissHelpDialog : ServerAction() {
    override fun ServerActionsContext.handle(state: ServerState): Flow<Mutation<ServerState>> =
        flowOf(ServerMutation.HideHelpDialog)
