...
@Composable
internal fun SettingsPrecacheThumbnailsPermissionDialog(
    action: (SettingsAction) -> Unit,
    onDismiss: () -> Unit,
) {
    AlertDialog(
        onDismissRequest = onDismiss,
        title = { Text(stringResource(string.precache_thumbnails)) },
        text = {
            Column {
                Text(stringResource(string.are_you_sure_you_want_to_perform_precache))
                Text(
