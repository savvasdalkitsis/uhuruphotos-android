...
import com.savvasdalkitsis.uhuruphotos.feature.search.view.implementation.seam.effects.NavigateToAllPeople
...
data object ViewAllPeopleSelected : SearchAction() {
    context(SearchActionsContext) override fun handle(
        state: SearchState,
        effect: EffectHandler<SearchEffect>
    ) = flow<SearchMutation> {
        effect.handleEffect(NavigateToAllPeople)
    }
}
