...
enum class DenormalizationType {
    ...
    FAVORITE_ADDED,
    FAVORITE_REMOVED,
    UPLOADING_LOCAL_MEDIA_QUEUED,
    UPLOADING_LOCAL_MEDIA,
    UPLOADING_LOCAL_MEDIA_SUCCEEDED,
    UPLOADING_LOCAL_MEDIA_FAILED,
    PROCESSING_UPLOADED_LOCAL_MEDIA_SUCCEEDED,
    PROCESSING_UPLOADED_LOCAL_MEDIA_MESSAGE_UPDATE,
    PROCESSING_UPLOADED_LOCAL_MEDIA_FAILED,
}