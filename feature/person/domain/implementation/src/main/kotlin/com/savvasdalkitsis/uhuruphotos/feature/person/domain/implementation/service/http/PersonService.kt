 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.person.domain.implementation.service.http
...
interface PersonService {
    ...
    suspend fun getMediaCollectionsForPerson(@Query("person") personId: Int): RemoteFeedResponseData

    @GET("/api/albums/date/{id}/")
    suspend fun getMediaCollectionForPerson(@Path("id") id: String, @Query("person") personId: Int): RemoteFeedDayResponseData
}