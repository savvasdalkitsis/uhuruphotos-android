...
sealed class ShowroomEffect {
    object NavigateBack : ShowroomEffect()
    object ErrorLoading : ShowroomEffect()
    ...
    data class NavigateToPerson(val personId: Int) : ShowroomEffect()
}
