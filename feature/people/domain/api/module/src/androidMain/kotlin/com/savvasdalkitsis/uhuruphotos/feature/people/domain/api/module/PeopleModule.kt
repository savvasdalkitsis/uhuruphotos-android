 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.people.domain.api.module
...
object PeopleModule {
    ...
    val peopleUseCase : PeopleUseCase
        get() = com.savvasdalkitsis.uhuruphotos.feature.people.domain.implementation.usecase.PeopleUseCase(
            peopleRepository,
        )

    private val peopleRepository get() = PeopleRepository(
        DbModule.database.peopleQueries,
        peopleService,
    )

    private val peopleService : PeopleService by singleInstance {
