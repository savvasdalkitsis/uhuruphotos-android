...
) : NavigationTarget<PeopleNavigationRoute>(PeopleNavigationRoute::class, registry) {

    @Composable
    override fun View(route: PeopleNavigationRoute, backStack: BackStack<NavigationRoute>) = with(navigationTargetBuilder) {
        ViewModelView(
