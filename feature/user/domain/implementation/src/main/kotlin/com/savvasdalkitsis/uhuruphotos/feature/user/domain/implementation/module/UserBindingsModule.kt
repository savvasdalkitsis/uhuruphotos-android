...
import com.savvasdalkitsis.uhuruphotos.feature.user.domain.implementation.usecase.UserUseCase
import dagger.Binds
...
internal abstract class UserBindingsModule {
    ...
    abstract fun userUseCase(userUseCase: UserUseCase):
            com.savvasdalkitsis.uhuruphotos.feature.user.domain.api.usecase.UserUseCase
