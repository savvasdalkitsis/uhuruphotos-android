 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.feed.domain.implementation.service.http
...
interface FeedService {
    ...
    suspend fun getRemoteFeed(): RemoteFeedResponseData

    @GET("/api/albums/date/list/")
    suspend fun getRemoteFeedSince(
        @Query("last_modified") since: String, // example: "2024-08-02T21:09:57Z"
    ): RemoteFeedResponseData

    @GET("/api/albums/date/{id}/")
    suspend fun getRemoteFeedDay(@Path("id") id: String, @Query("page") page: Int): RemoteFeedDayResponseData
