 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.feed.view.implementation.seam.effects
...
data class OpenLightbox(val id: MediaId<*>) : FeedEffect() {
    context(FeedEffectsContext) override suspend fun handle() {
        navigator.navigateTo(
            LightboxNavigationRoute(id, LightboxSequenceDataSource.Feed, showMediaSyncState = true)
        )
    }
}