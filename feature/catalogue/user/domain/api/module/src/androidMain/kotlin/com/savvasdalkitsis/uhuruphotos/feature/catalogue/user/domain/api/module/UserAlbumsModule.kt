...
object UserAlbumsModule {
    ...
    val userAlbumsUseCase: UserAlbumsUseCase
        get() = com.savvasdalkitsis.uhuruphotos.feature.catalogue.user.domain.implementation.usecase.UserAlbumsUseCase(
            userAlbumsRepository,
            PreferencesModule.plainTextPreferences,
        )

    private val userAlbumsRepository get() = UserAlbumsRepository(
        DbModule.database.userAlbumsQueries,
        userAlbumsService,
    )
