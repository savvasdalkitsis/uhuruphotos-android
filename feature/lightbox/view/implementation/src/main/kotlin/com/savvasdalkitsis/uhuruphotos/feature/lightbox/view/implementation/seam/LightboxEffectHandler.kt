...
class LightboxEffectHandler @Inject constructor(
    ...
    override suspend fun handleEffect(effect: LightboxEffect) {
        when (effect) {
            ...
            is AskForStorageManagementPermission ->
                navigator.navigateTo(effect.request.intent, effect.request.fallbackIntent)
        }
    }
