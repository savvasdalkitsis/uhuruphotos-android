...
import com.savvasdalkitsis.uhuruphotos.feature.lightbox.view.implementation.seam.effects.UseMediaAs
...
data object UseMediaItemAs : LightboxAction() {
    ...
    context(LightboxActionsContext) override fun handle(
        ...
        effect.handleEffect(UseMediaAs(state.currentMediaItem.id.fullResUri))
    }
