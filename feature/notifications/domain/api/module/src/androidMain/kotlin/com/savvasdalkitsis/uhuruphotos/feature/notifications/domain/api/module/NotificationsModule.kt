 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.notifications.domain.api.module
...
object NotificationsModule {
    ...
    val notificationsUseCase: NotificationsUseCase
        get() = com.savvasdalkitsis.uhuruphotos.feature.notifications.domain.implementation.usecase.NotificationsUseCase(
            AndroidModule.notificationManager,
            notificationActivityInitializer,
            PreferencesModule.plainTextPreferences,
        )

    val notificationActivityInitializer: NotificationActivityInitializer by singleInstance {
        NotificationActivityInitializer()
    }
}