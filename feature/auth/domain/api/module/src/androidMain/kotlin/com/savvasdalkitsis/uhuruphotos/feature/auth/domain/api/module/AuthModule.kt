...
object AuthModule {
    ...
    val cookieManager: CookieManager by singleInstance {
    ...
    val tokenRefreshOkHttpClient: OkHttpClient by singleInstance {
        authenticatedOkHttpBuilder
            .addInterceptor(tokenRefreshInterceptor)
            .build()
    }

    val authenticationService: AuthenticationService by singleInstance {
    ...
    val authenticationHeaderInjector: AuthenticationHeaderInjector by singleInstance {
