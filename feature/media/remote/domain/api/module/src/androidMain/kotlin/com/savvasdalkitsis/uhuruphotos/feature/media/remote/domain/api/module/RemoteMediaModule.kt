 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.media.remote.domain.api.module
...
object RemoteMediaModule {

    val remoteMediaUseCase: RemoteMediaUseCase
        get() = RemoteMediaModule.remoteMediaUseCase

    val remoteMediaPrecacher: RemoteMediaPrecacher
        get() = com.savvasdalkitsis.uhuruphotos.feature.media.remote.domain.implementation.usecase.RemoteMediaPrecacher(
            AndroidModule.applicationContext,
            ImageModule.thumbnailImageLoader,
        )
}