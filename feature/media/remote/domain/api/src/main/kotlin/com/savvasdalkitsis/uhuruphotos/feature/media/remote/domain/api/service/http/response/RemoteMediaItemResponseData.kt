...
data class RemoteMediaItemResponseData(
    ...
    @field:Json(name = "people") val people: List<RemoteMediaItemPeopleResponse>?,
...
private val RemoteMediaItemResponseData.serializePeople: String?
    get() = people?.joinToString(separator = "::") { it.name }

val String.deserializePeopleNames: List<String>
    get() = split("::")

private val RemoteMediaItemResponseData.serializePaths: String?
...
fun RemoteMediaItemResponseData.toDbModel() = DbRemoteMediaItemDetails(
    imageHash = imageHash,
    timestamp = timestamp,
    captions = captions,
    location = location,
