...
object RemoteMediaModule {
    ...
    val remoteMediaUseCase: RemoteMediaUseCase
        get() = com.savvasdalkitsis.uhuruphotos.feature.media.remote.domain.implementation.usecase.RemoteMediaUseCase(
            SettingsModule.settingsUseCase,
            remoteMediaRepository,
            remoteMediaService,
            remoteMediaItemWorkScheduler,
            UserModule.userUseCase,
            DbModule.database.remoteMediaItemSummaryQueries,
            DbModule.database,
        )

    val remoteMediaRepository: RemoteMediaRepository
    ...
    private val remoteMediaItemWorkScheduler: RemoteMediaItemWorkScheduler
        get() = RemoteMediaItemWorkScheduler(
