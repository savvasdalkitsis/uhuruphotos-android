 ...
 */
package com.savvasdalkitsis.uhuruphotos.feature.uploads.view.implementation.module
...
internal object UploadsModule {

    val uploadsActionsContext get() = UploadsActionsContext(
        UploadsModule.uploadsUseCase,
        WorkerModule.workPruneUseCase,
    )
}