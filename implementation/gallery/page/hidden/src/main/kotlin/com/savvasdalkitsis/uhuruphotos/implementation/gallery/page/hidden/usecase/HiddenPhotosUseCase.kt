 ...
 */
package com.savvasdalkitsis.uhuruphotos.implementation.gallery.page.hidden.usecase
...
internal class HiddenPhotosUseCase @Inject constructor(
    ...
    fun getHiddenMediaGalleryDisplay(): GalleryDisplay = hiddenMediaGalleryDisplay.get()
