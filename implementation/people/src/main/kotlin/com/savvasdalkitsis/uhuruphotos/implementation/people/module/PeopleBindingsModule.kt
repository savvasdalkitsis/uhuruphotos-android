...
import com.savvasdalkitsis.uhuruphotos.implementation.people.navigation.PeopleNavigationTarget
...
abstract class PeopleBindingsModule {
    ...
    abstract fun peopleUseCase(peopleUseCase: PeopleUseCase):
            com.savvasdalkitsis.uhuruphotos.api.people.usecase.PeopleUseCase
