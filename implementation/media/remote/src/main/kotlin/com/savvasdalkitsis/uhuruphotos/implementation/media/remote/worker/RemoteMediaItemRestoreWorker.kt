...
class RemoteMediaItemRestoreWorker @AssistedInject constructor(
    ...
    private fun shouldRestoreLocally(response: Response<com.savvasdalkitsis.uhuruphotos.implementation.media.remote.service.model.RemoteMediaOperationResponseServiceModel>) =
